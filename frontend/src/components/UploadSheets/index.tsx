...
export const UploadSheets = () => {
    ...
    const itemTemplate = (inFile: object, { formatSize, onRemove }: ItemTemplateOptions) => {
        ...
        return (
            <div className="flex align-items-center flex-wrap">
                ...
                <Button type="button" icon="pi pi-times" className="p-button-outlined p-button-rounded p-button-danger ml-auto" onClick={(event) => onRemove?.(event)} />
            </div>
        );
    };
